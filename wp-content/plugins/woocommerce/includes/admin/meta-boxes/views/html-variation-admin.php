		...
		<div class="data">
			...
			<div class="variable_pricing">
				<p class="form-row form-row-first">
					...
					<input type="text" size="5" name="variable_regular_price[<?php echo $loop; ?>]" value="<?php if ( isset( $_regular_price ) ) echo esc_attr( $_regular_price ); ?>" class="wc_input_price" placeholder="<?php esc_attr_e( 'Цена вариации', 'woocommerce' ); ?>" />
				</p>
