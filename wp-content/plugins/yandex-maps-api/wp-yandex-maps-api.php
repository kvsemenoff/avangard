...
class wpYandexMapAPI{
    ...
    public function __construct(){
        $this::$YaMapApiUrl = "http://api-maps.yandex.ru/2.1/?load=package.full&lang=ru-RU";
        $this->add_hooks();
    }
    ...
    public function handleShortcodes($attr, $content){
        ...
        $Z = <<<YaMapScript
<div id='yamap_div_{$this::$YaMapNumber}' style='width:{$mapProp->width}; height:{$mapProp->height}; ' class='yamapapi'></div>
{$YaMapDescription}
YaMapScript;
        $Y = <<<YaMapScript
