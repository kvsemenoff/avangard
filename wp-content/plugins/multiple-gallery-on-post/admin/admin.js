	...
	$('.mgop_add').bind('click', function( event ){
		...
		file_frame.on( 'select', function() {
			...
			selection.map( function( attachment ) {
				...
				var the_list = $('<li class="mgop_thumnails" title="Drag and drop to sort the item"><div><span class="mgop-movable"></span><a href="#" class="mgop_remove_item" title="Click to delete this item"><span>delete</span></a><img src="'+ attachment.url +'"><input type="hidden" name="mgop_media['+ the_for +'][]" value="'+ attachment.id +'" /></div></li>').hide();
