...
<div class="rpwe-columns-3 rpwe-column-last">
    ...
    <p>
        <input id="<?php echo $this->get_field_id( 'all_posts' ); ?>" name="<?php echo $this->get_field_name( 'all_posts' ); ?>" type="checkbox" <?php checked( $instance['all_posts'] ); ?> />
        <label for="<?php echo $this->get_field_id( 'all_posts' ); ?>">
            <?php _e( 'Display All Posts Link', 'recent-posts-widget-extended' ); ?>
        </label>
    </p>

    <p>
        <input id="<?php echo $this->get_field_id( 'home_template' ); ?>" name="<?php echo $this->get_field_name( 'home_template' ); ?>" type="checkbox" <?php checked( $instance['home_template'] ); ?> />
        <label for="<?php echo $this->get_field_id( 'home_template' ); ?>">
            <?php _e( 'Home template', 'recent-posts-widget-extended' ); ?>
        </label>
    </p>
