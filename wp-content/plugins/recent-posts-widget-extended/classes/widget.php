...
class Recent_Posts_Widget_Extended extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
        ...
        $instance['all_posts']    = isset( $new_instance['all_posts'] ) ? (bool) $new_instance['all_posts'] : false;
        $instance['home_template']    = isset( $new_instance['home_template'] ) ? (bool) $new_instance['home_template'] : false;
