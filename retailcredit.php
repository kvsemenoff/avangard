    ...
    <form id="creditForm" action=""  method="POST">
        <table style="font-family: Arial, Helvetica, sans-serif; font-size: 14px">
            ...
            <tr>
                ...
                <td align="left">
                    <input type="text" Name="SummTovar" style="font-family: Arial, Helvetica, sans-serif; width: 100%; font-size: 12px" value="<? echo number_format($summ, 2, '.', '');?>"/>
                </td>
            </tr>
            <tr>
                <td style="border-width: thin; border-color: #C0C0C0; border-bottom-style: solid;">
            ...
            <tr>
                ...
                <td align="left">
                    <select Name="Region">
                        <option>Москва</option><option>Московская область</option><option>Санкт-Петербург</option><option>Ленинградская область</option><option>Другой Регион</option>
                    </select>
